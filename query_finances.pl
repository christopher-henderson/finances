...
main :-
  ...
  Salary = 120000,
  Loans = 114000,
  % LoansAsAPercentageOfPostTax = 0.35,
  MonthlyPayment = 800,
  Rent = 2500,
  % RentAsAPercentageOfPostTax = 0.33,
  Groceries = 450,
  Utilities = 500,
  % RentAsAPercentageOfPostTax = 0.44,
  RetirementAsAPercentageOfPostTax = 0.06,
  % GroceriesAsAPercentageOfPostTax = 0.10,
  % UtilitiesAsAPercentageOfPostTax = 0.05,
  ...
  write("RetirementAsAPercentageOfPostTax: "), write(RetirementAsAPercentageOfPostTax), nl,
